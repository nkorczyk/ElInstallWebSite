package iamjosh.samples.preloader
{
	...
	{
        //~ Settings ----------------------------------------------------------
        private static var _BarWidth     : int = 250;  // Progress bar width
        private static var _BarHeight    : int = 10;   // Progress bar height
        private static var _LogoHeight   : int = 85;   // Logo picture height
        private static var _LogoWidth    : int = 150;  // Logo picture width
        ...
        private static var _TopMargin    : int = 5;    // Top Margin
        ...
        private static var _BarOuterBorder : uint = 0x2c1b01; // color of outer border
        private static var _BarColor       : uint = 0xFFFF00; // color of prog bar
        private static var _BarInnerColor  : uint = 0xFFFFFF; // inner color of prog bar

		//~ Instance Attributes -----------------------------------------------
		[Embed(source="../../../assets/banner/ori1.jpg")]
        ...
        private function draw() : BitmapData
        {
        	...
        	// draw the logo
        	data.draw(this._logo.bitmapData, null, null, "alpha", null, true);
        	return data;
        }
